...
`presentation` declara `keyCardId`, `theme` y `descriptionKey`; no volver a resolver esos valores
por id dentro de componentes. Cada deck lleva su manifest de imagenes junto al JSON.
