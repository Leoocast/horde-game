export const sfxManifest = {
  click: new URL("../../assets/sounds/click_NEED_REVIEW.wav", import.meta.url).href,
  draw: new URL("../../assets/sounds/draw_NEED_REVIEW.mp3", import.meta.url).href,
  drawOne: new URL("../../assets/sounds/draw_one_NEED_REVIEW.wav", import.meta.url).href,
  playLand: new URL("../../assets/sounds/play_land_NEED_REVIEW.wav", import.meta.url).href,
  playMonster: new URL("../../assets/sounds/play_monster_NEED_REVIEW.wav", import.meta.url).href,
  playMonsterEffect: new URL("../../assets/sounds/play_monster_effect_NEED_REVIEW.wav", import.meta.url).href,
  playMonsterHeavy: new URL("../../assets/sounds/play_monster_heavy_NEED_REVIEW.wav", import.meta.url).href,
  attack: new URL("../../assets/sounds/attack_NEED_REVIEW.wav", import.meta.url).href,
  ...
  skipNextBattle: new URL("../../assets/sounds/skip_next_battle_NEED_REVIEW.wav", import.meta.url).href,
  activateEffect: new URL("../../assets/sounds/activate_effect_NEED_REVIEW.wav", import.meta.url).href,
  buff: new URL("../../assets/sounds/buff_NEED_REVIEW.wav", import.meta.url).href,
  pactOfElarionBuff: new URL("../../assets/sounds/pact_of_elarion_buff.mp3", import.meta.url).href,
  ...
  selectAttacker: new URL("../../assets/sounds/select_attacker.wav", import.meta.url).href,
  stoneCrash: new URL("../../assets/sounds/stone_crash.wav", import.meta.url).href,
  vaelorLinePlay: new URL("../../assets/sounds/vaelor_line_play.mp3", import.meta.url).href,
} as const;
