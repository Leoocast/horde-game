...
export type ContextualHighlightRef =
  | Readonly<{ kind: "card"; instanceId: string; role?: GuidedHighlightRole; padding?: number }>
  | Readonly<{ kind: "surface"; anchor: GuidedSurfaceAnchor; role?: GuidedHighlightRole; padding?: number }>;
