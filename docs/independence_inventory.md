...
El deck lint mantiene un WIP ya conocido: las habilidades de `hollow_bell`. No es una regresión de
...
- `src/data/decks/host/hollow_bell_procession/hollow_bell_procession.json` declara
...
- `public/cards/last_rain/first_dew_gatherers.png` imprime `Criatura`;
- `public/cards/broken_forge_mutiny/varka_revolt_axis.png` imprime `Criatura` y `Daña primero`;
- `public/cards/hollow_bell_procession/last_march_marshal.png` imprime `Criatura`, `Toque mortal` y `Horda`;
- `public/cards/crimson_court/court_duelist.png` imprime `Criatura` y `pagar 3 vidas`.
...
Cierre de L2 (2026-07-31): el manifest y la verificación por hashes ya existen. La Última Lluvia (13 PNG)
...
Avance L3.1 (2026-07-31): La Última Lluvia ya usa schema Hostfall `1.0.0`. El auditor bajó de 425 a 327
...
sus respectivos bloques. La Última Lluvia y Vampiros conservan huellas de generación válidas.
...
| Ruta | Archivos |
| --- | ---: |
| `public/cards/last_rain` | 26 |
| `public/cards/hollow_bell_procession` | 17 |
| `public/cards/broken_forge_mutiny` | 17 |
...
L7 retiró los ids, rutas, comentarios y nombres de fixtures derivados que seguían activos. El
auditor conserva como información únicamente vocabulario legacy dentro de pruebas negativas que
verifican su rechazo; no existe un adaptador o alias runtime que lo acepte.
...
| Arte derivado bajo los tres árboles originales | Resuelto en L6; ids y rutas resueltos en L7 |
| 1025 coincidencias en pruebas y aliases finales | Resuelto por dominio en L4 y cerrado en L7 |
