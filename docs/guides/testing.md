...
| `tests/attemptMilestones.test.js` | Grabador acotado de hitos: scope por sesión, primera Oleada, máximos de impacto, efecto multiobjetivo, umbral del Archivo, fuente exacta de victoria, deduplicación, copias inmutables y prohibición de leer `game.log` |
