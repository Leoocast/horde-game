...
| `tests/seedExplorer.test.js` | Analyzer, búsqueda, runtime y persistencia: Mano/mulligan/topes exactos, recursos y curva impresa, ventanas potenciales de Hueste, scoring/filtros, rango base 36, top-K estable, pool verificado y selección diversa determinista, slices cancelables, progreso limitado, protección contra búsquedas obsoletas, favoritos defensivos, export JSON/CSV y verificación contra el engine |
