...
| `tests/deckLint.test.js` | El deck lint como test: una habilidad desconocida rompe la suite; también protege el schema Hostfall `1.0.0`, sus campos canónicos y la equivalencia del adaptador temporal |
